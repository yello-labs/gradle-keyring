...
public class FunctionalTest {
	...
	public void applyToProject() throws IOException {
		writeFile(new File(projectDir, "build.gradle"), String.format(buildTemplate, "id 'org.yellolab" + ".gradle" +
	...
	public void applyToSettings() throws IOException {
		writeFile(new File(projectDir, "settings.gradle"), String.format(buildTemplate,
	...
	public void methodAvailableEverywhere() throws IOException {
		writeFile(new File(projectDir, "build.gradle"), String.format(buildTemplate, "id 'org.yellolab.gradle-keyring'", "  \n" + "import org.yellolab.KeyringPlugin;\n" + "KeyringPlugin.getSecret('','')\n" + "task(\"test\") {\n" + "    doLast {\n" + "        KeyringPlugin.getSecret('','')\n" + "    }\n" + "}\n" + "gradle.afterProject {\n" + "    KeyringPlugin.getSecret('','')\n" + "}\n" + "\n" + "gradle.beforeProject {\n" + "    KeyringPlugin.getSecret('','')\n" + "}"));
